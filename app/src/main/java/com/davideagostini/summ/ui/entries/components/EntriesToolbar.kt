            ...
            Surface(
                ...
                IconButton(onClick = onToggleSearch) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.content_desc_search_entries),
                        tint = if (searchVisible) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurface,
                    )
                }
            }
        }
        ...
        if (searchVisible) {
            OutlinedTextField(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 12.dp),
                placeholder = { Text(stringResource(R.string.entries_search_placeholder)) },
